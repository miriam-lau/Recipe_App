...
class TestCookbookManager(unittest.TestCase):
    ...
    def test_create_and_initialize_cookbook_manager(self):
        ...
        self.assertEqual(cookbooks[0], Cookbook(4, "Joy of Cooking", "Great"))
        self.assertEqual(cookbooks[1], Cookbook(2, "Momofuku", "Okay"))
    ...
    def test_add_cookbook(self):
        ...
        self.assertEqual(cookbooks[0], Cookbook(5, "America's Test Kitchen", "Bad"))
        self.assertEqual(cookbooks[1], Cookbook(1, "Atelier Crenn", "Superb"))
        self.assertEqual(cookbooks[2], Cookbook(4, "Joy of Cooking", "Great"))
        self.assertEqual(cookbooks[3], Cookbook(2, "Momofuku", "Okay"))
        self.assertEqual(cookbooks[4], Cookbook(3, "Smitten Kitchen", "Meh"))

    def test_get_cookbook(self):
        cookbook_manager = CookbookManager.create_and_initialize_cookbook_manager("testing/cookbooks.txt")
        cookbook = cookbook_manager.get_cookbook(2)
        self.assertEqual(cookbook, Cookbook(2, "Momofuku", "Okay"))
