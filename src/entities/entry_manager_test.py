...
class TestEntryManager(unittest.TestCase):
    ...
    def test_create_and_initialize_entry_manager(self):
        ...
        self.assertEqual(entries[0], Entry(10, 8, "2018-10-22", 9.5, 9.1, "Good", "Delicious"))
        self.assertEqual(entries[1], Entry(11, 9, "2018-01-02", 4, 2, "Terrible", "Disgusting"))
    ...
    def test_add_entry(self):
        ...
        entry_manager.add_new_entry(
            recipe_manager, Entry(None, 8, "2018-04-05", 2, 1, "Bland", "Gross"), "testing/test_add_entry.txt")
        entry_manager.add_new_entry(
            recipe_manager, Entry(None, 9, "2018-07-19", 9, 8, "Excellent", "Good"), "testing/test_add_entry.txt")
        entries = entry_manager.get_entries()

        self.assertEqual(len(entries), 5)
        self.assertEqual(entries[0], Entry(1, 8, "2017-05-24", 7, 6, "Okay", "Meh"))
        self.assertEqual(entries[1], Entry(2, 8, "2018-04-05", 2, 1, "Bland", "Gross"))
        self.assertEqual(entries[2], Entry(3, 9, "2018-07-19", 9, 8, "Excellent", "Good"))
        self.assertEqual(entries[3], Entry(10, 8, "2018-10-22", 9.5, 9.1, "Good", "Delicious"))
        self.assertEqual(entries[4], Entry(11, 9, "2018-01-02", 4, 2, "Terrible", "Disgusting"))
